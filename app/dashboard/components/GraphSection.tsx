...
export default function GraphSection() {
  ...
  const drawGraph = () => {
    ...
    // Draw area under curve - always fill to baseline
    if (path && points.length > 1) {
      const baselineY = padding.top + graphHeight;
      
      // Create area path that follows the visible curve and fills to baseline
      // Don't clip the area - let it extend naturally, but the curve itself is clipped
      ...
      // Don't clip the area - we want it to fill to baseline
